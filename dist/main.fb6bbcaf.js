...
var toTopEl = document.querySelector('#to-top'); // _.throttle(함수, 시간)
...
var isHidePromotion = false; //프로모션이 보여지고 있니? NO!
...
spyEls.forEach(function (spyEl) {
  new ScrollMagic.Scene({
    //Scene=스크롤매직을 통해 특정한 요소를 감시하는 옵션 지정
